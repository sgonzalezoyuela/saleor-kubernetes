locals {
  ...
  computed_storefront_url = local.storefront_lb_ip != "" ? "http://storefront.${local.storefront_lb_ip}.nip.io:3000" : (
    var.public_access ? var.storefront_url : "http://localhost:3000"
  )
}
